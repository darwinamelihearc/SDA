...
import ch.heg.ig.sda.datastructure.ArrayListDynamic;
...
class Serie3 {
    ...
    public static void main(final String[] args) {
        ...
        al.add(p1);
        al.add(p2);
        // al.add(p3); // Throws IllegalStateException
        ...
        System.out.println("--------------------------------------------------------");
        System.out.println("--- ArrayListDynamic ---");
        List ald = new ArrayListDynamic(2);
        // ald.remove(3); // Throws IndexOutOfBoundsException
        ald.add(p1);
        ald.add(p2);
        ald.add(p3); // Should not throw IllegalStateException or IndexOutOfBoundsException

        System.out.println("Avant suppression du dernier element : " + ald.size());
        ald.removeLast();
        System.out.println("Après suppression du dernier element : " + ald.size());
    }
}
